...
Please note we have a [Code Of Conduct](https://github.com/Open-Source-Community-VIT-AP/OSC-API/blob/main/.github/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
In short, when you submit code changes, your submissions are understood to be under the same [GNU GPL v3.0](https://github.com/Open-Source-Community-VIT-AP/OSC-API/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.